...
## create plot2
with(fpcons2, plot(Date, Sub_metering_1, type = "n", xlab = "", ylab = "Energy sub metering", cex.lab = 0.75, cex.axis = 0.75))
lines(fpcons2$datetime, fpcons2$Sub_metering_1, col = "black")
lines(fpcons2$datetime, fpcons2$Sub_metering_2, col = "red")
lines(fpcons2$datetime, fpcons2$Sub_metering_3, col = "blue")
